...
<section class="inner-w3ls">
	<div class="container">
		<h2 class="text-center w3 w3l agileinfo wthree">Contact Us</h2>
...
<section class="contact-us" id="contact">
	<div class="container">
		...
		<p class="text-center slideanim w3-agileits agileits-w3layouts agile w3-agile">We love to hear from you.</p>
            ...
            <div class="col-md-4 slideanim">
				<h4>Our Contacts :</h4>
                <p><b>Phone</b> : +23480 2381 9571</p>
                <p><b>Email</b> : <a href="mailto:info@ultimatemarine.com">info@ultimatemarine.com</a>
                <p><b>Address</b> : 3 Alhaji Moshood Tijani street, Apapa Lagos-Nigeria.</p>
            </div>
...
<section class="contact-w3ls">
	<div class="container">
		...
		<p class="text-center">Have an inquiry/complaint about any of our services? Fill the box below.</p>	
